...
#### License
This work **© 2024 by Guillaume Desagulier** is licensed under **CC BY-NC 4.0**. (Note: The copyright year is dynamically generated by the script using the system date.)
